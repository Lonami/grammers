...
impl Client {
    ...
    ///
    /// client.send_album(&chat, vec![InputMessage::caption("A album").photo_url("https://www.pixelstalk.net/wp-content/uploads/2016/03/Free-cute-animal-wallpaper-HD.jpg")]).await?;
    /// # Ok(())
    /// # }
    /// ```
    ///
